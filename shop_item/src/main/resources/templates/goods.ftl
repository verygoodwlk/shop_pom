		...
		<div class="shop_hd_topNav">
			<div class="shop_hd_topNav_all">
				...
				<div class="shop_hd_topNav_all_left">
					<p>您好，欢迎来到<b><a href="/">ShoopNC商城</a></b>[<a >登录</a>][<a >注册</a>]</p>
				</div>
			...
			<div class="shop_goods_show_left">
				...
				<div id="preview">
					<div class=jqzoom id="spec-n1" onClick="window.open('/')">
						<IMG height="350" src="http://192.168.226.160/${goods.gimage}" jqimg="http://192.168.226.160/${goods.gimage}" width="350">
						</div>
						<div id="spec-n5">
							<div class=control id="spec-left">
								<img src="http://192.168.226.160/${goods.gimage}" />
							</div>
							<div id="spec-list">
								<ul class="list-h">
									<li><img src="http://192.168.226.160/${goods.gimage}"> </li>
								</ul>
							</div>
			...
			<div class="shop_goods_show_right">
				<ul>
					...
					<li style="padding:20px 0;">
						<label>&nbsp;</label>
						<span><a  class="goods_sub goods_sub_gou" >加入购物车</a></span>
					</li>
				</ul>
			</div>
		</div>
